...
* 클래스 설계
* 기능 목록
  * [x] 사다리 하단 결과를 입력받는 기능
    * [x] 꽝 or 숫자가 아니면 예외처리
    * [x] 참여한 사람의 숫자와 하단 실행 결과의 개수가 다르면 예외처리
  * [x] 입력받은 하단 결과를 사다리 리스트에 추가 하는 기능
  * [x] 사다리 게임 결과를 입력받는 기능
    * [x] 사용자의 이름을 입력하면 개인별 결과를 출력하는 기능
    * [x] "all"을 입력하면 전체 사용자의 실행결과를 출력하는 기능
    * [x] "춘식이" 를 입력하면 프로그램을 종료하는 기능
  * [x] 사다리 리스트에서 결과를 탐색하는 기능
* 트러블 슈팅
  * 다시 처음부터 구현하는게 필요..
